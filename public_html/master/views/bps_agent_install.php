...
REM The encoding of this file must be ASCII not unicode
REM Created: Alex Fiedler 21 July 2014
REM 
pushd %cd%
sc create HowLateAgent start= delayed-auto  error= normal binpath= "%CD%\HowLateAgent.exe" displayname= "How-Late Agent for BestPractice"
