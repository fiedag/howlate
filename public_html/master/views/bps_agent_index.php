...
<div class='container primary-content'>
    ...
    <div class="xcrud-nav">
        <a href="/bps_agent/exe"><button class="xcrud-button xcrud-cyan">Download HowLateAgent.exe</button></a>
    </div>
    <h3>2. Please supply the connection information to be written to the config file</h3>

    <form id="clinicselect" name="clinicselect" method="post" action="/bps_agent/clinicselect">
    ...
    <form id="org" name="org" method="post" action="/bps_agent/update">
        <div class="control-group">
    ...
    <div class="xcrud-nav">
        <a href="/bps_agent/install"><button class="xcrud-button xcrud-cyan ">Download Script</button></a>
    </div>
    <h3>5. Click below for further instructions.</h3>
    <div class="xcrud-nav">
        <a href="/bps_agent/further"><button class="xcrud-button xcrud-cyan ">Further Instructions</button></a>
    </div>
