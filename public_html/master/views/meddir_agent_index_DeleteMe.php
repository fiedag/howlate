...
<div class='container primary-content'>
    <h3>1. Download the executable and place in e.g. C:\Program Files\HowLateAgent\ folder of your Medical Director Server.</h3>
    <div class="xcrud-nav">
        <a href="/meddir_agent/exe"><button class="xcrud-button xcrud-cyan">Download HowLateAgent.exe</button></a>
    </div>
    <h3>2. Please supply the connection information to be written to the config file</h3>

    <form id="clinicselect" name="clinicselect" method="post" action="/meddir_agent/clinicselect">
    ...
    <form id="org" name="org" method="post" action="/meddir_agent/update">
        <div class="control-group">
        ...
        <div class="control-group">
            <label class="control-label" for="Trusted">Trusted_Login:</label>
            <input type="checkbox" class="controls" id="Trusted" name="Trusted" readonly checked></input>
        </div>
    ...
    <div class="xcrud-nav">
        <a href="/meddir_agent/install"><button class="xcrud-button xcrud-cyan ">Download Script</button></a>
    </div>
    <h3>5. Click below for further instructions.</h3>
    <div class="xcrud-nav">
        <a href="/meddir_agent/further"><button class="xcrud-button xcrud-cyan ">Further Instructions</button></a>
    </div>
