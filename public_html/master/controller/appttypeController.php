...
Class ApptTypeController Extends baseController {
    ...
    public function getXcrudTable() {
        ...
        $xcrud->table('appttype')->table_name('Appointment types.','Updated by the HL Agent.  Mark those appointment types you wish to ignore for purposes of lateness calculations.  This means they act as if they are gaps.')->where('OrgID =', $this->org->OrgID)->limit(30);
