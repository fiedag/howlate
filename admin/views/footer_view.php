        ...
        <div class="container">
            ...
            <div class="footer-border">
                <div class="span-10 append-1">
                    <h4>Product</h4>
                    <ul>
                        <li><a target="_blank" href="https://<?php echo __DOMAIN; ?>/pricing.php" id="footer-feature">Billing</a></li>
                        <li><a href="http://<?php echo __FQDN; ?>/help" id="footer-feature">Help</a></li>
                        <!-- li><a target="_blank" href="https://<?php echo __FQDN; ?>/support/newfeatures">New Features</a></li -->
                    </ul>
                </div>
                <div class="span-8 append-1">
                    <h4>Community</h4>
                    <ul>
                        <li><a target="_blank" href="https://<?php echo __DOMAIN;?>/welcome/blog/">Blog</a></li>
                        <li><a target="_blank" href="https://<?php echo __DOMAIN;?>/faq.php">FAQ</a></li>
                    </ul>
                </div>
                <div class="span-8 append-1">
                    <h4>Company</h4>
