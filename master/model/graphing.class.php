...
class Graphing {
    ...
    function __construct() {
        require_once (__SITE_PATH . '/includes/jpgraph/src/jpgraph.php');
        require_once (__SITE_PATH . '/includes/jpgraph/src/jpgraph_scatter.php');
        require_once (__SITE_PATH . '/includes/jpgraph/src/jpgraph_line.php');
        require_once (__SITE_PATH . '/includes/jpgraph/src/jpgraph_mgraph.php');
    }
