    ...
    <div class="col-sm-6">
        ...
        <ul class="list-group">
            <li class="list-group-item">
                <h4 class="list-group-item-heading">Cannot connect</h4>If the agent cannot connect to the database or the details change, re-download the .config file with new details, or edit the .config file yourself with a text editor.</li>
            <li class="list-group-item"><h4 class="list-group-item-heading">Not updating</h4>If the doctor's lateness is not updating, ensure the FullName of the doctor on the how-late site is exactly the same as the Provider Name in the Best Practice system.</li>
        </ul>
